...
export const deliveryNote = pgTable("delivery_note", {
  ...
  deliveryType: varchar("delivery_type", { length: 32 }).notNull().default("Full"),
  deliveryAddress: text("delivery_address"),
  deliveryNotes: text("delivery_notes"),
  deliveryDocument: text("delivery_document"),
  deliveryDocumentName: varchar("delivery_document_name", { length: 128 }),
  deliveryDocumentSize: integer("delivery_document_size"),
  pickingStartedBy: uuid("picking_started_by"),
  pickingStartedAt: timestamp("picking_started_at"),
  pickingCompletedBy: uuid("picking_completed_by"),
  pickingCompletedAt: timestamp("picking_completed_at"),
  pickingNotes: text("picking_notes"),
  deliveryConfirmedBy: varchar("delivery_confirmed_by", { length: 128 }),
...
export const deliveryItem = pgTable("delivery_item", {
  id: uuid("id").primaryKey().defaultRandom(),
  deliveryId: uuid("delivery_id").notNull().references(() => deliveryNote.id, { onDelete: "cascade" }),
